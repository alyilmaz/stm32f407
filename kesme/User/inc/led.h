...
#define sari_toggle	GPIO_ToggleBits(GPIOD,GPIO_Pin_13)
#define kirmizi_toggle	GPIO_ToggleBits(GPIOD,GPIO_Pin_14)
#define yesil_toggle	GPIO_ToggleBits(GPIOD,GPIO_Pin_12)
